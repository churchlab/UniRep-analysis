...
import common_v2.vectorize_for_benchmarking_lib
from common_v2.vectorize_for_benchmarking_lib import get_dumb_features, get_freq_and_len, get_bow_representations, transform_bow_to_tfidf
...
class trainable_transfer_mean_model:
    def __init__(self):
        pass
